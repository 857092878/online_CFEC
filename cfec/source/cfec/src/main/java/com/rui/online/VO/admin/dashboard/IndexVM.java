package com.rui.online.VO.admin.dashboard;
...
public class IndexVM {
    ...
    public String toString() {
        return "IndexVM{" +
                ...
                ", doExamPaperCount=" + doExamPaperCount +
                ", doQuestionCount=" + doQuestionCount +
                ", mothDayUserActionValue=" + mothDayUserActionValue +
                ", mothDayDoExamQuestionValue=" + mothDayDoExamQuestionValue +
                ", mothDayText=" + mothDayText +
                '}';
    }
}
